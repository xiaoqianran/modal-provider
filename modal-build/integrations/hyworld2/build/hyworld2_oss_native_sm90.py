...
TAG = "hyworld2-oss-native-py311-cu128-torch271-sm90-v1"
...
app = modal.App("modal-build-hyworld2-oss-native-sm90")
...
def build() -> dict:
    ...
    if torch.cuda.get_device_capability() != (9, 0):
        raise RuntimeError(
            f"expected sm_90, got {torch.cuda.get_device_name()} {torch.cuda.get_device_capability()}"
        )
    ...
    manifest = {
        ...
        "smoke": ["gpu-sm90", "pytorch3d-cuda-knn", "fused-ssim-cuda", "spz-import"],
    }

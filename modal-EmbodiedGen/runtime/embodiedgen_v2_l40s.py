"""EmbodiedGen v2.0.0 L40S release-consumer compute runtime.

Production request routing/orchestration lives on the local VPS/client. This Modal app
contains compute workers only; it intentionally has no ASGI gateway or CPU orchestrator.
